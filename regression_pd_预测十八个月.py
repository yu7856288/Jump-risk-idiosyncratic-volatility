...
def calcFirstRegression(y_var,x_vars):
    ...
    first_regression_data["r_rft"] = first_regression_data["r_rft"].shift(-18) ###预测18个月
...
if __name__ == "__main__":
    ...
    second_regression_result="d:/pandas/result/跳跃含iv_预测18个月_coef.xls"
    logger.info("########################################################################################")
    logger.info("predict 18 month")
